...
const UserLookup = () => {
    ...
    {searchCriteria ? (<Stack alignItems={"flex-start"}>  
        ...
        <input {...register("Name", { required: true })} className = {styles.inputsupplier} />
        </div>
        <div className={styles.inputrow}>
        <label className={styles.labelinputcertificate}>Supplier index</label>
        <input {...register("First name", { required: true })} className = {styles.inputsupplier}/>
        </div>
        <div className={styles.inputrow}>
        <label className={styles.labelinputcertificate}>City</label>
        <input {...register("User ID", { required: true })} className = {styles.inputsupplier}/>
        </div>

        <div className={styles.inputrow}>
        <label className={styles.labelinputcertificate}>Supplier index</label>
        <input {...register("Department", { required: true })} className = {styles.inputsupplier}/>
        </div>
        <div className={styles.inputrow}>
        <label className={styles.labelinputcertificate}>City</label>
        <input {...register("Plant", { required: true })} className = {styles.inputsupplier}/>
        </div>
        </form>
